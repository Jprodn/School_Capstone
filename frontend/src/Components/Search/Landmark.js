...
function Landmark(props) {
  ...
  React.useEffect(() => {
    ...
    console.log("%ccurrentItineraryInfo", landmarkTheme, currentItineraryInfo);
  ...
  const handleAdd = async (e) =>
    await axios
      ...
      .then(swal("Success!", "Landmark has been added!", "success"))
  ...
  async function handleSubmit(event) {
    ...
    await axios
      ...
      .then(swal("Thank you!", "You review was submitted!", "success"));
    setTimeout(() => {
  ...
  useEffect((config) => {
    const getLikeCounts = async () => {
      await axios
        .get(
          `${baseUrl}/landmark/rating/like-count/${review.landmarkId}`,
          config
        )
        .then((val) => {
          setLikes((prevLikes) => ({
  ...
  useEffect((config) => {
    const getDislikeCounts = async () => {
      await axios
        .get(
          `${baseUrl}/landmark/rating/dislike-count/${review.landmarkId}`,
          config
        )
        .then((val) => {
          setLikes((prevLikes) => ({
    ...
    <div className="main-div">
      <div className="contacts">
        <div className="contact-card">
          <img
            src={require(`../../Images/${props.item.imgUrl}`)}
            alt="landmark-img"
          />
