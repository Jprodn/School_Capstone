...
export default function Itinerary(props) {
  ...
  useEffect(() => {
    ...
    console.log("%ccurrentItineraryInfo", itineraryTheme, currentItineraryInfo);
  ...
  useEffect(() => {
    ...
    const getUserLandmarks = async () => {
      ...
      console.log("getUserLandMarks: " + currentItineraryInfo.itineraryId);
      console.log("%cgetUserLandmarks: result", itineraryTheme, result.data);
      if (isMounted) {
  ...
  function storeData() {
    userLandmarks.forEach((lm) => {
      ...
      localStorage.setItem(
        "address",
        `${lm.address}, ${lm.city}, ${lm.state}, ${lm.postalCode}`
      );
    });
  }
      ...
      <div className="itinerary-card-body">
        <ul className="landmark-list">
          <li className="landmark-list-items">
            <button className="startPoint-button" onDoubleClick={isBeingEdit}>
              {isEditing ? (
                <input
                  name="startingPoint"
